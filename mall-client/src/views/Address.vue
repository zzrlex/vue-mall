<template>
    <div>
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  ...
                  <li class="addr-new">
                    <div class="add-new-inner" @click="addadrModalFlag=true">
                      <i class="icon-add">
      ...
      <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':addadrModalFlag}">
          <div class="md-modal-inner">
            <div class="md-top">
              <div class="md-title">请填入地址信息</div>
              <button class="md-close" @click="addadrModalFlag=false">Close</button>
            </div>
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap">
                  <span class="error error-show" v-show="tip" v-text= "tip"></span>
                </div>
                <ul>
                  <li class="regi_form_input">
                    <input type="text" tabindex="1" name="shouhuoName" v-model="receiver" class="regi_login_input regi_login_input_left" placeholder="receiver" data-type="loginname">
                  </li>
                  <li class="regi_form_input">
                    <input type="text" tabindex="2"  name="streetName" v-model="streetName" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="street name" >
                  </li>
                  <li class="regi_form_input">
                    <input type="text" tabindex="2"  name="postCode" v-model="postCode" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="postCode" >
                  </li>
                  <li class="regi_form_input">
                    <input type="text" tabindex="2"  name="telNum" v-model="telNum" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="tel number" @keyup.enter="addadr">
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
                <a href="javascript:;" class="btn-login" @click="addadr"> 添 加 </a>
              </div>
            </div>
          </div>
        </div>
        <div class="md-overlay" v-if="addadrModalFlag" @click="addadrModalFlag=false;tip=''"></div>
      ...
      methods:{
          init(){
              axios.get("/users/addressList").then((response)=>{
                  ...
                  if (!this.addressList[0].addressId) {
          ...
          addadr() {
            if(!this.receiver || !this.streetName|| !this.postCode|| !this.telNum){
                  this.tip = "请输入完整地址信息";
                  return;
            }
            axios.post("/users/addadr",{
