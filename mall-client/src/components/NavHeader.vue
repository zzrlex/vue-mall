        ...
        <div class="navbar">
            ...
            <div class="navbar-right-container" style="display: flex;">
              <div class="navbar-menu-container">
                ...
                <a href="javascript:void(0)" class="navbar-link" @click="loginModalFlag=true" v-if="!nickName">Log in </a>
        ...
        <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':signupModalFlag}">
          <div class="md-modal-inner">
            ...
            <div class="md-content">
              <div class="confirm-tips">
                <div class="error-wrap">
                  <span class="error error-show" v-show="tips" v-text = "tips"></span>
                </div>
                <ul>
                  <li class="regi_form_input">
                    <i class="icon IconPeople"></i>
                    <input type="text" tabindex="1" name="signupname" v-model="signupName" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2"  name="password1" v-model="signupPwd" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password">
                  </li>
                  <li class="regi_form_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2"  name="password2" v-model="PwdConfirm" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="please confirm" @keyup.enter="signup">
                  </li>
                </ul>
              </div>
              <div class="login-wrap">
    ...
    export default{
        ...
        methods:{
            signup () {
              ...
              if (this.signupPwd != this.PwdConfirm) {
                this.tips = '确认密码不一致';
                return;
              }
